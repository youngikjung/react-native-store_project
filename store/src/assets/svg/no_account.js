...
export const ComponentNoAccount = ({iHeight,iWidth,iColor}) => {
  let sWidth = 40;
  let sHeight = 40;
  let sColor = "#000";
  ...
  return (
    <Svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height={sHeight} viewBox="0 0 24 24" width={iWidth} fill={sColor}>
    <G>
