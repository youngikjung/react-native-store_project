...
import mPromotionImg from '../../../assets/img/m_promotion.png';
import mPromotionItemImg from '../../../assets/img/m_promotionItem.png';
        ...
        <View style={{flex:1, backgroundColor: "#fff"}}>
            ...
            <>
                ...
                <ScrollView style={{flex:1, backgroundColor: "#fff"}}>
                    ...
                    {textInputType === "" &&
                        <View style={{height: height * 1.1, width, alignItems: "center", justifyContent: "space-around" }}>
                            <View style={{height: height * 0.3, width: width * 0.8, alignItems: "center", justifyContent: "center" }}>
                                <Image source={mPromotionImg} style={{width: "100%", height : "100%", borderRadius: width * 0.03, resizeMode: "stretch"}}/>
                            </View>
                            <View style={{height: height * 0.1, width: width * 0.8, alignItems: "center", justifyContent: "center" }}>
                                <Text style={{fontWeight: "600", fontSize: RFPercentage(1.9), color: "#4E5867" }}>스루를 이용하는 매장에 필요한</Text>
                                <Text style={{fontWeight: "600", fontSize: RFPercentage(1.9), color: "#4E5867" }}>스루 홍보물을 보내드립니다.</Text>
                                <Text style={{fontWeight: "600", fontSize: RFPercentage(1.9), color: "#4E5867" }}>매장을 방문하는 고객에게 스루 시작을 알려보세요!</Text>
                            </View>
                            <View style={{height: height * 0.6, width: width * 0.8, alignItems: "center", justifyContent: "center" }}>
                                <Image source={mPromotionItemImg} style={{width: "100%", height : "100%", borderRadius: width * 0.03, resizeMode: "stretch"}}/>
                            </View>
                        </View>
                    }
                    ...
                    {(textInputType === "" || textInputType === "address") &&
                        <TouchableOpacity onPress={addressSetting} style={{height: height * 0.15, backgroundColor: "#fff", justifyContent: "center", alignItems: "center"}}>
                    ...
                    {(textInputType === "" || textInputType === "extra") &&
                        <View style={{height: textInputType === "extra" ? height * 0.15 : height * 0.1, backgroundColor: "#fff", justifyContent: "center", alignItems: "center"}}>
                            {textInputType === "extra" &&
                                <View style={{height: height * 0.05, backgroundColor: "#fff", width, justifyContent: "center", marginLeft: "10%"}}>
